...
public class ScreenFrameViewModel : ViewModel<Monitor>, IMvvmContextProvider, IScreenFrameViewModel
{
    ...
    readonly IProperty<IMultiScreensViewModel> _presenter = H.Property<IMultiScreensViewModel>();

    public TransformGroup Rotation => _rotation.Get();

    readonly IProperty<TransformGroup> _rotation = H.Property<TransformGroup>(c => c
        
        .Set( e => 
            {
                if (e.Model.Orientation == 0) return null;
    ...
    readonly IProperty<Thickness> _logoPadding = H.Property<Thickness>(c => c
    ...
    readonly IProperty<double> _left
    ...
    readonly IProperty<double> _top 
        = H.Property<double>(c => c
            .Set(e =>
            {
                if (e.Presenter == null) return 0.0;
    ...
    readonly IProperty<IDisplaySize> _rotated = H.Property<IDisplaySize>(c => c
//            .NotNull(e => e.Model)
//            .NotNull(e => e.Presenter)
        .Set(e =>
        {
    ...
    readonly IProperty<IDisplaySize> _unrotated = H.Property<IDisplaySize>(c => c
        .Set(e =>
        {
...
//            .On(e => e.Model.Orientation)
    ...
    readonly IProperty<Stretch> _wallPaperStretch = H.Property<Stretch>(c => c
        .NotNull(e => e.Model)
        .Set(e =>
        {
    ...
    readonly IProperty<Image> _wallPaper = H.Property<Image>(c => c
        .NotNull(e => e.Model)
        .Set(e =>
        {
            try
    ...
    readonly IProperty<Brush> _backgroundColor = H.Property<Brush>(c=>c
    ...
    readonly IProperty<string> _logo = H.Property<string>(c => c
        .Set(e => e.GetLogo())
