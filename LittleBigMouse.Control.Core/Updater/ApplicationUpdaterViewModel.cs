...
namespace LittleBigMouse.Control.Updater;
...
public class ApplicationUpdateViewModel : ViewModel
{
    ...
    readonly IProperty<bool> _updated = H.Property<bool>();

    public Version CurrentVersion => _currentVersion.Get();

    readonly IProperty<Version> _currentVersion = H.Property<Version>(c => c.Set(
        e =>
        {
            try
            {
