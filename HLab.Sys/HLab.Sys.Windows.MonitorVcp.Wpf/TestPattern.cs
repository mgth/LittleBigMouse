...
namespace HLab.Sys.Windows.MonitorVcp
{
    ...
    {
        static readonly Color Red = new Color{A=0xFF,R=0xFF,G=0x00,B=0x00};
        static readonly Color Green = new Color{A=0xFF,R=0x00,G=0xFF,B=0x00};
        static readonly Color Blue = new Color{A=0xFF,R=0x00,G=0x00,B=0xFF};
        static readonly Color White = new Color{A=0xFF,R=0xFF,G=0xFF,B=0xFF};
        static readonly Color Black = new Color{A=0xFF,R=0x00,G=0x00,B=0x00};
        ...
        public Window Show(Rect location)
        {
            ...
            panel.MouseDoubleClick += (s, e) => { panel.Close(); };
