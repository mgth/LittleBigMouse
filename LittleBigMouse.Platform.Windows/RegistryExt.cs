/*
  LittleBigMouse.Platform.Windows
  Copyright (c) 2021 Mathieu GRENET.  All right reserved.

  This file is part of LittleBigMouse.Platform.Windows.

    LittleBigMouse.Platform.Windows is free software: you can redistribute it and/or modify
    it under the terms of the GNU General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    LittleBigMouse.Platform.Windows is distributed in the hope that it will be useful,
