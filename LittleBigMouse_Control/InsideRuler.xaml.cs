...
namespace LittleBigMouse_Control
{
    ...
    public partial class InsideRuler : Window
    {
        ...
        public InsideRuler(Screen screen)
        {
            ...
            Rect r = new Rect(screen.Bounds.TopLeft.Wpf.Point,screen.Bounds.BottomRight.Wpf.Point);
            ...
            double ratioX = screen.WpfToPixelRatioX;
            double ratioY = screen.WpfToPixelRatioY;
