...
/// </summary>
public partial class DefaultMonitorView : UserControl, IView<DefaultViewMode, DefaultMonitorViewModel>, IMonitorFrameContentViewClass
{
    public DefaultMonitorView() 
    {
        InitializeComponent();
    }
